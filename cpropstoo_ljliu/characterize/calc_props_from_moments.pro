...
; COEFFICIENT FOR VIRIAL MASS CALCULATION
  ...
  ihr = float((strsplit(ra_c_str,'h',/extract))[0])
  imin = float((strsplit((strsplit(ra_c_str,'h',/extract))[1], 'm', /extract))[0])
  xsec = float((strsplit((strsplit(ra_c_str,'m',/extract))[1], 's', /extract))[0])

  ideg = float((strsplit(dec_c_str,'d',/extract))[0])
  imn = float((strsplit((strsplit(dec_c_str,'d',/extract))[1], 'm', /extract))[0])
  xsc = float((strsplit((strsplit(dec_c_str,'m',/extract))[1], 's', /extract))[0])
  ...
  dec_c = dec_c * ideg/abs(ideg)
    ...
    props.gal_dv =  abs(sxpar(hdr, 'CDELT3'))
